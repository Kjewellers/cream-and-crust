  ...
  return (
    ...
    >
      <div className="rv-wizard-header">
        ...
        <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--rv-pink)' }}>{done}/{items.length}</div>
      </div>
      ...
      <div className="rv-wizard-content">
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 14, color: 'var(--rv-pink)', fontWeight: 700 }}>{Math.round(done / items.length * 100)}%</span>
          </div>
        ...
        {done === items.length && (
          <motion.div
            ...
            style={{
              marginTop: 24, background: '#D1FAE5', borderRadius: 16,
              padding: 24, textAlign: 'center'
            }}
          >
            <div style={{ fontSize: 48, marginBottom: 8 }}>🎉</div>
            <div style={{ fontWeight: 800, color: '#10B981', fontSize: 18 }}>All Steps Complete!</div>
            <div style={{ fontSize: 14, color: '#065F46', marginTop: 4 }}>Your recipe is ready to serve!</div>
          </motion.div>
        )}
      </div>
