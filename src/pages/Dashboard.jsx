...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const customersUnsub = subscribeToCustomers(
      (newCust) => {
    ...
    const expensesUnsub = subscribeToExpenses(
      (newExp) => {
        setExpenses(newExp || []);
      },
      null,
    ...
    const shoppingUnsub = subscribeToShoppingList(
      (items) => {
    ...
    <motion.div variants={listContainer} initial="hidden" animate="show" className="fade-in">
      <PullToRefresh
        onRefresh={async () => {
          ...
          // Removed toast so it feels like a silent, native auto-refresh pull
        }}
      >
