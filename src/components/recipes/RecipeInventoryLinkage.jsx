          ...
          {LINKED.map((item, i) => (
            <div
              ...
              style={{
                ...
                alignItems: 'center',
                padding: '14px 16px',
                borderBottom: i < LINKED.length - 1 ? '1px solid var(--rv-border)' : 'none',
              }}
            >
              <div style={{ flex: 1, fontWeight: 600, fontSize: 14 }}>{item.name}</div>
              <div
                style={{ width: 80, fontSize: 14, color: 'var(--rv-muted)', textAlign: 'center' }}
              >
                {item.qty}
              </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: '#92400E', marginTop: 2 }}>
              Only 1.5 kg remaining. Reorder before your next batch!
            </div>
          </div>
        </div>
      </div>
