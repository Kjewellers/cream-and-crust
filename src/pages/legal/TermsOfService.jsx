  ...
  return (
    <LegalLayout title="Terms of Service" subtitle="The agreement" updated={UPDATED}>
      ...
      <P>
        ...
        compliance. We rely on third-party services (such as Firebase, Cloudinary, Google Play and
        RevenueCat) whose availability we don't control.
      </P>
      ...
      <P>
        ...
        your use of the app. Our total liability for any claim related to the app shall not exceed
        the amount you paid us in the 12 months preceding the claim. The app is a record-keeping
        and management tool; you remain responsible for your business decisions, pricing, taxes and
